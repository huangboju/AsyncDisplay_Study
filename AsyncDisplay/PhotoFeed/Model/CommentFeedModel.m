...
- (NSInteger)numberOfItemsInFeed
{
  return [_comments count];
}

- (CommentModel *)objectAtIndex:(NSInteger)index
{
  return [_comments objectAtIndex:index];
}

- (NSInteger)numberOfCommentsForPhoto
{
  return _totalItems;
}

- (BOOL)numberOfCommentsForPhotoExceedsInteger:(NSInteger)number
{
